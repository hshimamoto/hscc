...
try 'int f(a,b,c){a*b+c;} int main(){int A;int B;int C;A=8;B=5;C=2;f(A,B,C);}' 42
try 'int f(a,b,c){a*b+c;} int main(){int A;int B;int C;A=2;B=8;C=5;f(B,C,A);}' 42
try 'int f(a,b,c,d,e,f){a+b+c+d+e+f;} int main(){int A;int B;int C;A=5;B=10;C=15;f(A,B,C, A,B,C);}' 60
